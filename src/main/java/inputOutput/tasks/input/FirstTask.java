...
/* Napisz program zamieniający temperaturę podaną w stopniach Celsjusza na temperaturę wyrażoną w stopniach Fahrenheita.
...
public class FirstTask {
    public static void main(String[] args) throws IOException {
        ...
        //1) Convert temperature Centigrade to temperature Fahrenheit.
       ...
       //2) Convert temperature Fahrenheit to temperature Centigrade .
